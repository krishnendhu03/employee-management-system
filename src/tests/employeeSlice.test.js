...
describe("employeeSlice async thunks", () => {
  ...
  test("fetchEmployees successfully loads employees", async () => {
    ...
    expect(
      fetchEmployees.fulfilled.match(result)
    ).toBe(true);
    ...
    expect(
      store.getState().employee.employees
    ).toEqual(employees);

    expect(
      store.getState().employee.loading
    ).toBe(false);

    expect(
      store.getState().employee.error
    ).toBeNull();
  });
  ...
  test("fetchEmployees handles API error", async () => {
    ...
    expect(
      fetchEmployees.rejected.match(result)
    ).toBe(true);
  ...
  test("addEmployee successfully adds an employee", async () => {
    ...
    expect(
      addEmployee.fulfilled.match(result)
    ).toBe(true);
  ...
  test("updateEmployee successfully updates an employee", async () => {
    ...
    // Put existing employee into Redux state
    store.dispatch({
